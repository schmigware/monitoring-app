...
public class WebsocketConfiguration implements WebSocketConfigurer {
  ...
  @Value("${discovery.service.endpoints.topology-update}")
   ...
   */
  public WebsocketConfiguration(@NonNull final DiscoveryService discoveryService,
  ...
  public WebSocketHandler environmentPushMessageHandler() {
    return new DiscoveryServiceMessageHandler(this.discoveryService);
  }
