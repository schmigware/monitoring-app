package org.cit.mcaleerj.thesis.correlation.controller;
...
import org.cit.mcaleerj.thesis.correlation.resolver.CommandResolver;
...
/**
 * Correlation service GraphQL endpoint controller.
 */
@RestController
public class GraphQlController {
   ...
   *
   * @param correlationService The correlation service.
   */
  public GraphQlController(final CorrelationService correlationService) {

    GraphQLSchema schema = new GraphQLSchemaGenerator()
            .withResolverBuilders(
                    new AnnotatedResolverBuilder(),
                    new PublicResolverBuilder("org.cit.mcaleerj.thesis.correlation"))
            .withOperationsFromSingleton(new CommandResolver(correlationService))
            .withValueMapperFactory(new JacksonValueMapperFactory("org.cit.mcaleerj.thesis.correlation.dto"))
            .generate();
